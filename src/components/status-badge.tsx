...
const statusColors: Record<string, { bg: string; text: string }> = {
  ...
  emergency: { bg: 'bg-red-500/10 dark:bg-red-400/15', text: 'text-red-700 dark:text-red-400' },
  urgent: { bg: 'bg-red-500/10 dark:bg-red-400/15', text: 'text-red-700 dark:text-red-400' },
  destructive: { bg: 'bg-orange-500/10 dark:bg-orange-400/15', text: 'text-orange-700 dark:text-orange-400' },
  damaging: { bg: 'bg-yellow-500/10 dark:bg-yellow-400/15', text: 'text-yellow-700 dark:text-yellow-400' },
  cosmetic: { bg: 'bg-gray-500/10 dark:bg-gray-400/15', text: 'text-gray-600 dark:text-gray-400' },
