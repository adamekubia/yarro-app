...
function TodoPanel({ todoItems, allTickets }: { todoItems: TodoItem[]; allTickets: TicketSummary[] }) {
  ...
  return (
    <div className="rounded-xl border border-border/60 flex flex-col min-w-0 overflow-hidden min-h-[45vh] lg:min-h-0 lg:flex-1">
      ...
      actionable.length === 0 ? (
        ...
        <div className="flex flex-col divide-y divide-border/40 overflow-y-auto overflow-x-hidden max-h-[38vh] lg:flex-1 lg:min-h-0 lg:max-h-none">
          {actionable.map(item => {
        ...
        inProgressTickets.length === 0 ? (
          ...
          <div className="flex flex-col divide-y divide-border/30 overflow-y-auto overflow-x-hidden max-h-[38vh] lg:flex-1 lg:min-h-0 lg:max-h-none">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto lg:overflow-hidden p-4 flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex flex-col gap-4 md:grid md:grid-cols-2 md:gap-4 lg:grid-cols-1 lg:grid-rows-2 lg:h-full lg:w-[clamp(320px,30vw,420px)] lg:min-w-[320px] lg:max-w-[420px] min-w-0">
              ...
              {(() => {
                ...
                return (
                  <div className="rounded-xl border border-border/60 flex flex-col min-w-0 overflow-hidden min-h-[45vh] lg:min-h-0">
                    ...
                    <div className="flex flex-col overflow-y-auto p-4 max-h-[38vh] lg:flex-1 lg:min-h-0 lg:max-h-none">
            ...
            {/* Recent activity */}
            <div className="rounded-xl border border-border/60 flex flex-col overflow-hidden min-h-[45vh] lg:min-h-0">
              ...
              <div className="divide-y divide-border/30 overflow-y-auto max-h-[38vh] lg:flex-1 lg:min-h-0 lg:max-h-none">
