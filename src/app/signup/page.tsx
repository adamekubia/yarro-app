          ...
          {emailSent ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full h-11 flex items-center justify-center gap-3 rounded-md border border-border bg-background text-sm font-medium text-foreground hover:bg-muted transition-colors"
              >
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                {error && (
                  <div className="text-sm text-red-500 bg-red-50 dark:bg-red-950/30 dark:text-red-400 px-3 py-2 rounded-lg">
                    {error}
                  </div>
                )}
