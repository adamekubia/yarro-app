...
Every session reads: GUARDRAILS.md, SCHEMA.md, DECISIONS.md, ARCHITECTURE.md. Enter plan mode. Agree scope.
...
Session ends with: test plan (what was tested), reinforcement audit (SSOT check, naming check, guardrail check, decisions logged, docs in sync).
