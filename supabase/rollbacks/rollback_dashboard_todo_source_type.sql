-- Rollback: c1_get_dashboard_todo before source_type addition
-- Original location: 20260327041845_remote_schema.sql lines 3987-4129
-- Restore with: psql -f rollback_dashboard_todo_source_type.sql
