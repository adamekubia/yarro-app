-- Rollback: c1_get_dashboard_todo before perf optimization
-- Original location: 20260404710000_dashboard_todo_source_type.sql lines 13-168
-- Restore with: psql -f rollback_dashboard_todo_perf.sql
-- Note: rollback_dashboard_todo_source_type.sql also exists (rolls back further)
