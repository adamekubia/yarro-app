-- ============================================================
-- PROTECTED RPC CHANGE: c1_get_dashboard_todo — add source_type
-- ============================================================
-- Safe Modification Protocol:
--   Backup: supabase/rollbacks/rollback_dashboard_todo_source_type.sql
--   Approved by: Adam (polymorphic dispatch alignment)
--
-- Adds source_type, entity_id, and property_id to the JSONB output
-- so the frontend can group compliance/rent tickets correctly
-- (instead of all tickets landing in the Maintenance bucket).
-- ============================================================
