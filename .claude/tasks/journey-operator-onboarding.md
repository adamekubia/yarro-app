...
|---|-------|-------|-----------|-----------|--------|-----|
| 1 | Landing page | 1 | Marketing page, "Start for free" CTA → `/signup` | — | Next | Small |
| 2 | Account + property cards | 2 | Card-based onboarding: account details → property with room count + type. Replaces current wizard steps 1+3 | Slice 1 | Pending | Medium |
